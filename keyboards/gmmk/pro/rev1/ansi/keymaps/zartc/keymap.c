...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------------+------+------+------+------+------+------+------+------+------+------+-++=====++------++======|
     * |   Fn   |  LAlt  | LCtrl |                Space                  | RAlt | RCtrl| Win  || Left | Down | Right |
     * '------------------------------------------------------------------------------------------------------------'
     */
    [BASE] = LAYOUT(
    ...
    //  -------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        MO(FN), KC_LALT,  KC_LCTL,                            KC_SPC,                             KC_RALT, KC_RCTL, KC_LGUI,  KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    //  ----------------------------------------------------------------------------------------------------------------------------------------------------------
       TO(NUM),  _______, _______,    _______,    _______, _______, _______, _______, _______, _______, _______, KC_PMNS, KC_PPLS, _______,               _______,
    ...
    //  ----------------------------------------------------------------------------------------------------------------------------------------------------------
        TO(BASE), KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PMNS, KC_PPLS, _______,               _______,
     ...
     * |--------------+------+------+------+------+------+------+------+------+------+------+-++=====++------++======|
     * |   Fn   |  LAlt  | LCtrl |                Space                  | RAlt | RCtrl| Win  ||MedPrv|MedNxt|MedNxt |
     * '------------------------------------------------------------------------------------------------------------'
     */
    [FN] = LAYOUT(
